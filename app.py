...
def predict():
    ...
    predictions = classify_playlist(user, playlist_id)
    print(predictions)
...
def savePlaylist():
    ...
    sp.user_playlist_create(user=user,name=playlist_name,public=False,description="Generated by Matthew Lim.")

    def getPlaylistID(user, playlist_name):
        playlist_id = ''
